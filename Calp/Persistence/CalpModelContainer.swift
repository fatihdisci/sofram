//
//  CalpModelContainer.swift
//  Calp — the SwiftData stack, backed by the user's CloudKit PRIVATE database.
//
...
enum CalpModelContainer {
    ...
    static let cloudKitContainerID = "iCloud.com.fatih.calp"

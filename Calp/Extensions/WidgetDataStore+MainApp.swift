...
//  Calp — convenience method that queries SwiftData and writes the widget summary.
//
//  This file is compiled ONLY into the main Calp target (not the widget extension).
...
//    • CalpApp.onChange(scenePhase) — catch-up on foreground
//
...
extension WidgetDataStore {
    ...
    ///   - calorieTarget: Daily calorie target from UserDefaults key "calp.dailyCalorieTarget" (default 2000).

...
//  Calp — read/write WidgetDailySummary to shared App Group UserDefaults.
//
...
//
//  Included in both the Calp (main app) and CalpWidgetExtension targets.
//
...
enum WidgetDataStore {
    ...
    static let appGroupID = "group.com.fatih.calp"

    /// Key under which the JSON blob is stored in shared UserDefaults.
    static let summaryKey = "calp.widget.dailySummary"
    static let pendingFrequentMealsKey = "calp.widget.pendingFrequentMeals"

//
//  PortionUnit.swift
//  Calp — Turkish household portion vocabulary (core product concept).
//
...
enum PortionUnit: String, Codable, CaseIterable, Identifiable, Hashable {
    ...
    case tencere      = "tencere"        // pot — shared-portion total (Calp Modu, v1.1)
    ...
    /// Optional custom icon from the Calp icon set (used by steppers/pickers).
    var icon: CalpIcon? {
        switch self {

...
//  Calp — evidence-based constants for the calorie/macro engine.
//
...
enum LegalLinks {
    ...
    static let privacyPolicy = URL(string: "https://calp.app/privacy")!
    // TODO(fatih): gerçek URL
    static let termsOfUse = URL(string: "https://calp.app/terms")!
}

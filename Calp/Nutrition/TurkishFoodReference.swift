...
//  Calp — lazy loader for the bundled Türkiye food reference DB.
//
//  Source: `Calp/Resources/turkish_food_reference.json` (Phase B3 prep).
...
enum TurkishFoodReference {
    ...
    private static let queue = DispatchQueue(label: "calp.turkish_food_reference.cache")

//
//  Layout.swift
//  Calp — spacing, radius and motion constants from design-tokens.json
//
...
extension Animation {
    /// Standard Calp spring (response 0.4, damping 0.75) from the motion token block.
    static let calpSpring = Animation.spring(

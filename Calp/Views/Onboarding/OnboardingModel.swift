...
//  Calp — onboarding flow state + Mifflin-St Jeor calorie calculator.
//
...
enum OnboardingStep: Int, CaseIterable {
    ...
    var title: String {
        ...
        case .paywall:  return String(localized: "Calp'e Başla")
        }
    }
...
final class OnboardingModel {
    ...
    private enum Keys {
        static let completed = "calp.onboardingCompleted"
    }
    ...
    func saveProfile(to context: ModelContext) {
        ...
        UserDefaults.standard.set(dailyCalorieTarget, forKey: "calp.dailyCalorieTarget")
        UserDefaults.standard.set(proteinTargetG, forKey: "calp.proteinTarget")
        UserDefaults.standard.set(carbsTargetG, forKey: "calp.carbsTarget")
        UserDefaults.standard.set(fatTargetG, forKey: "calp.fatTarget")

//
//  PaywallView.swift
//  Calp — "Dürüst Paywall" (Honest Paywall).
//
...
struct PaywallView: View {
    ...
    @State private var selectedProductID = CalpProductID.annual
    @State private var isRestoring = false

    /// The currently selected product.
    private var selectedProduct: Product? {
        selectedProductID == CalpProductID.monthly
    ...
    private var heroSection: some View {
        VStack(spacing: Layout.Spacing.md) {
            ZStack {
                ...
                CalpIconView(icon: .calp, size: 28)
    ...
    private var featureCard: some View {
        VStack(alignment: .leading, spacing: Layout.Spacing.sm) {
            ...
            // `target` (accuracy/isabet), not `sparkles` — Calp avoids
        ...
        VStack(alignment: .leading, spacing: Layout.Spacing.sm) {
            ...
            HStack(spacing: Layout.Spacing.sm) {
                planCard(
                    ...
                    productID: CalpProductID.annual,
                    badge: "En Uygun",
                    period: "yıl",
                ...
                planCard(
                    ...
                    productID: CalpProductID.monthly,
                    badge: nil,
                    period: "ay",
    ...
    private func periodLabel(for productID: String) -> String {
        productID == CalpProductID.annual ? "Yıllık toplam" : "Aylık"
    }

    private var periodLabel: String {
        selectedProductID == CalpProductID.annual ? "yıl" : "ay"
    }

...
//  Calp — branded, open-C daily calorie gauge.
//
//  The gauge is intentionally not a generic completion ring. Its open track is
//  the Calp C; logged calorie groups leave quiet markers along the path,
...
struct CalorieRingView: View {
    ...
    @AppStorage("calp.ringDisplayMode") private var displayModeRaw = RingDisplayMode.remaining.rawValue
    ...
    var body: some View {
        ZStack {
            ...
            .animation(reduceMotion ? nil : .calpSpring, value: displayModeRaw)
        }
        .frame(width: gaugeSize, height: gaugeSize)
        .contentShape(Circle())
        .onTapGesture {
            withAnimation(reduceMotion ? nil : .calpSpring) {

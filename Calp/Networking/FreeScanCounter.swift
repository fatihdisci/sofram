...
//  Calp — device-level display of the server-enforced free scan quota.
//
...
final class FreeScanCounter {
    ...
    private enum Keys {
        static let photoUsed = "calp.freePhotoScansUsed"
        static let textUsed = "calp.freeTextScansUsed"
        static let subscribed = "calp.isSubscribed"
        static let dayStart = "calp.freeScanDayStart"
    }

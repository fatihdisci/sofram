...
//  Sofra — iOS 17 native motion patterns ported from
...
//  SofraPulseShine    → PhaseAnimator wrapper for any future "primary
...
//                       milestone badge.
//  SofraStaggerReveal → generic Phase Animator list reveal. NOT wired in

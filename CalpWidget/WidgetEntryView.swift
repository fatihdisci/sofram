...
//  CalpWidgetExtension — small and medium widget layouts.
//
//  Design follows the flat Calp palette, simplified for WidgetKit:
...
struct CalpWidgetEntryView: View {
    ...
    private var accessoryCircularLayout: some View {
        ...
        .widgetURL(URL(string: "calp://daily")!)
    }
    ...
    private var smallLayout: some View {
        ZStack {
            ...
            VStack(spacing: Layout.Spacing.sm) {
                ringView(ringSize: 110, font: .calpDisplayNumeric)
                caloriesCaption
            }

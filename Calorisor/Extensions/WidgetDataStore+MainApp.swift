...
//  Calorisor — convenience method that queries SwiftData and writes the widget summary.
//
//  This file is compiled ONLY into the main Calorisor target (not the widget extension).
...
//    • CalorisorApp.onChange(scenePhase) — catch-up on foreground
//

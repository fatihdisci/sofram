...
struct PaywallView: View {
    ...
    private var selectedProduct: Product? {
        selectedProductID == CalorisorProductID.monthly
    ...
    private var heroSection: some View {
        VStack(spacing: Layout.Spacing.md) {
            ZStack {
                ...
                CalorisorIconView(icon: .calorisor, size: 28)
        ...
        VStack(alignment: .leading, spacing: Layout.Spacing.sm) {
            ...
            HStack(spacing: Layout.Spacing.sm) {
                planCard(
                    ...
                    productID: CalorisorProductID.annual,
                    badge: "En Uygun",
                    period: "yıl",
                ...
                planCard(
                    ...
                    productID: CalorisorProductID.monthly,
                    badge: nil,
                    period: "ay",
    ...
    private var periodLabel: String {
        selectedProductID == CalorisorProductID.annual ? "yıl" : "ay"
    }

...
//  Calorisor — anonymous, device-scoped installation identity.
//
...
//   • Kept in the Keychain under `com.fatih.calorisor.installation-id`.
...
struct SystemKeychainStore: InstallationKeychainStore {
    ...
    init(service: String = "com.fatih.calorisor") {
...
final class InstallationIdentity {
    ...
    static let keychainKey = "com.fatih.calorisor.installation-id"
    ...
    /// Its `uuidString` form, ready to drop into the `x-calorisor-installation-id`

...
- [~] **SF-1104 · Proxy: cihaz bazlı günlük limitler (Free 1+2, Pro 50+100)** ⏸ NOT: Kod yazıldı + `npm run typecheck` temiz; §27 senaryoları elle izlendi. Otomatik testler SF-1204 vitest harness'ında (Redis/OpenAI mock) toplanacak.
...
- [ ] **SF-1204 · Basit rapor script'i + proxy test altyapısı**
  ...
  **Kabul:** `npm test` proxy dizininde §27 proxy listesini koşuyor.
